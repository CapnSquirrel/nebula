...
import rawGrammar from './nebula.ohm';
...
const astGenerator = grammar.createSemantics().addOperation('ast', {
  ...
  Function: (_1, id, location, _2, body) => new Function(id.ast(), location.ast(), body.ast()),
  FunctionBlock: (_1, params, _return, _2) => [...params.ast(), _return.ast()],
  Parameter: (_1, id, location, _2, _3, body, _5) =>
    new Parameter(id.ast(), location.ast(), ...body.ast()),
  Return: (_1, location, _2, _3, control, _4) => new Return(location.ast(), ...control.ast()),
  Initialize: (_1, type, value, _2) => new Initialize(type.sourceString, value.ast()),
  Access: (_1, type, id, _2) => new Access(type.sourceString, id.ast()),
  Evaluate: (_1, expr, _2) => new Evaluate(expr.ast()),
  ...
  Condition: (_1, _2, location, _3, _4, body, _5) => new Condition(location.ast(), body.ast()),
  TrueControl: (_1, _2, location, _3) => new Control(location.ast()),
  FalseControl: (_1, _2, location, _3) => new Control(location.ast()),
  Accessor: (_1, id, location, _2, body) => new Accessor(id.ast(), location.ast(), body.ast()),
  AccessorBlock: (_1, body, control, _2) =>
    (control ? [body.ast(), ...control.ast()] : [body.ast()]),
  SetParameter: (_1, _2, type, location, _3) => new SetParameter(type.sourceString, location.ast()),
  Link: (_, fromLocation, toLocation) => new Link(fromLocation.ast(), toLocation.ast()),
  Control: (_1, location, _3) => new Control(location.ast()),
